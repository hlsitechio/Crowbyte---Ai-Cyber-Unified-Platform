...
import { UilDesktop, UilGlobe, UilTimes, UilDownloadAlt } from "@iconscout/react-unicons";
        ...
        {showModal && (
          ...
          >
            <motion.div
              ...
              className="relative w-full max-w-sm mx-4 rounded-lg border border-white/10 bg-card p-6 shadow-2xl"
            >
              {/* Close */}
              <button
                onClick={() => setShowModal(false)}
              ...
              <div className="text-center mb-6">
                <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-blue-500/10 mb-3">
                  <UilDesktop size={24} className="text-blue-500" />
                </div>
              ...
              <div className="space-y-2">
                {/* UilDesktop App Option */}
                <button
                  onClick={() => setShowNotInstalled(true)}
                  className="w-full flex items-center gap-3 px-4 py-3 rounded-md border bg-blue-500/5 hover:bg-blue-500/10 transition-colors text-left group"
                >
                  <UilDesktop size={20} className="text-blue-500 flex-shrink-0" />
                ...
                <AnimatePresence>
                  {showNotInstalled && (
                    ...
                    >
                      <div className="px-4 py-3 rounded-md bg-amber-500/5 text-center">
                        <p className="font-['JetBrains_Mono'] text-xs text-amber-400">
                          UilDesktop app not detected
                        </p>
                ...
                >
                  <UilGlobe size={20} className="text-zinc-400 flex-shrink-0" />
                  <div>
