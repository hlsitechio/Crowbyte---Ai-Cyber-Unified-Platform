...
import {
  ArrowLeft, Shield, Brain, Terminal, MessageSquare, Database, Zap,
  Settings, Code2, Network, Activity,
  BookOpen, Crosshair, Swords, ShieldAlert, Target, Monitor, Bot,
  BarChart3, Bookmark, ScrollText, Search, Bug, Globe,
  FileText, Layers, Server,
  // New icons for new sections
  Download, Lock, TestTube2, Sparkles, Wrench, HardDrive, Plug, Radio,
  KeyRound, TerminalSquare, CircuitBoard,
} from "lucide-react";
...
const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "agent-testing", label: "Agent Testing", icon: TestTube2 },
      { id: "llm", label: "LLM Models", icon: Sparkles },
    ],
  },
  {
    label: "Red Team",
    ...
    items: [
      ...
      { id: "cyber-ops", label: "Cyber Ops", icon: Swords, badge: "95 tools" },
      { id: "tools-page", label: "Tools Registry", icon: Wrench },
      { id: "network-scanner", label: "Network Scanner", icon: Network },
    ],
  },
  {
    label: "Blue Team",
  ...
  },
  {
    ...
    items: [
      ...
      { id: "ai-providers", label: "AI Providers", icon: Radio },
      { id: "nvd-shodan", label: "NVD & Shodan", icon: Search },
    ],
  },
  {
    label: "Development",
    ...
    items: [
      ...
      { id: "electron-arch", label: "Electron Architecture", icon: CircuitBoard },
      { id: "data-security", label: "Data & Security", icon: KeyRound },
      { id: "cli-tools", label: "CLI Tools", icon: TerminalSquare },
      ...
      <div className="w-64 shrink-0 border-r border-border bg-sidebar flex flex-col">
        ...
        <div className="p-4 border-b border-primary/20 space-y-3">
          <div className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-2">
              <div className="flex h-7 w-7 items-center justify-center border border-primary/40 bg-black">
                ...
                {group.items.map((item) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {item.badge && (
                        <Badge variant="secondary" className="ml-auto text-[9px] h-4 px-1 bg-primary/20 text-primary border-primary/30">
                          {item.badge}
                        </Badge>
                      )}
                    </button>
