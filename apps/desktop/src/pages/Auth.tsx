...
export default function Auth() {
  ...
  const handleGitHubLogin = async () => {
    setLoading(true);
    try {
      // Use explicit redirect URL for Electron
      const redirectUrl = 'http://localhost:8081/#/auth';
    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      <div className="w-full max-w-md space-y-6">
        <div className="flex flex-col items-center gap-4">
          ...
          {deviceRecognized && (
            <div className="flex items-center gap-2 text-xs text-green-500 bg-green-950/30 px-3 py-1.5 rounded-full border border-green-500/30">
