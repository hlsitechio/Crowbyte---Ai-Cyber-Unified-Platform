...
import { Bookmark as BookmarkIcon, Search, Plus, Trash2, Edit, ExternalLink, Tag, Folder, FolderPlus } from "lucide-react";
      ...
      {loading ? (
        ...
        <Card>
          <CardContent className="text-center py-12">
            <BookmarkIcon className="h-16 w-16 mx-auto mb-4 text-muted-foreground/50" />
