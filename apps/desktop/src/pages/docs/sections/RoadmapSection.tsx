...
import { UilFocusTarget, UilAngleRight, UilCheckCircle } from "@iconscout/react-unicons";
import { DocHeader } from "../components";

export function RoadmapSection() {
  return (
    <div className="space-y-6">
      <DocHeader icon={UilFocusTarget} title="Roadmap" description="Completed milestones and planned features" />
      ...
      <Card className="border-transparent"><CardContent className="pt-6">
        <div className="text-sm font-medium text-emerald-500 mb-3 flex items-center gap-2">
          <UilCheckCircle size={16} /> Recently Completed
        </div>
      ...
      <Card className="border-transparent"><CardContent className="pt-6">
        ...
        <ul className="space-y-3 text-sm text-muted-foreground">
          {[
            ...
            "UilBracketsCurly execution sandbox within the app",
