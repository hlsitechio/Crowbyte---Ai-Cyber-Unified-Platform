      ...
      <Card><CardHeader><CardTitle>GHOST Agent Architecture</CardTitle></CardHeader>
        <CardContent>
          <CodeBlock>
            ...
            <div><span className="text-green-400">get_system_metrics</span>   <span className="text-zinc-500">CPU, RAM, disk, network stats</span></div>
            <div><span className="text-green-400">get_processes</span>        <span className="text-zinc-500">Running processes with PID, user, CPU%</span></div>
            <div><span className="text-green-400">get_connections</span>      <span className="text-zinc-500">Active network connections (like netstat)</span></div>
            <div><span className="text-green-400">check_ports</span>          <span className="text-zinc-500">Listening ports and bound services</span></div>
            <div><span className="text-green-400">analyze_logs</span>         <span className="text-zinc-500">Recent syslog/auth.log entries</span></div>
            <div>&nbsp;</div>
            <div className="text-zinc-500"># Output: structured threat report</div>
            <div><span className="text-primary">alerts[]</span></div>
            <div>  <span className="text-red-400">severity</span>:     info | warning | critical</div>
            <div>  <span className="text-yellow-400">category</span>:    process | network | system | auth</div>
            <div>  <span className="text-green-400">description</span>: What was detected</div>
            <div>  <span className="text-blue-400">recommendation</span>: What to do about it</div>
          </CodeBlock>
        </CardContent></Card>
