      ...
      <Card><CardHeader><CardTitle>IPC Channels</CardTitle></CardHeader>
        <CardContent>
          <CodeBlock>
            ...
            <div><span className="text-emerald-500">terminal:create</span>   <span className="text-zinc-500">Spawn node-pty (shell, cols, rows)</span></div>
            <div><span className="text-emerald-500">terminal:write</span>    <span className="text-zinc-500">Send input to pty stdin</span></div>
            <div><span className="text-emerald-500">terminal:resize</span>   <span className="text-zinc-500">Resize pty (cols, rows)</span></div>
            <div><span className="text-emerald-500">terminal:destroy</span>  <span className="text-zinc-500">Kill pty process</span></div>
            <div><span className="text-emerald-500">terminal:data</span>     <span className="text-zinc-500">Pty output → renderer (callback)</span></div>
            <div>&nbsp;</div>
            ...
            <div><span className="text-emerald-500">system:processes</span>  <span className="text-zinc-500">Running process list</span></div>
            <div><span className="text-emerald-500">window:minimize</span>   <span className="text-zinc-500">Minimize window</span></div>
            <div><span className="text-emerald-500">window:maximize</span>   <span className="text-zinc-500">Toggle maximize</span></div>
            <div><span className="text-emerald-500">window:close</span>      <span className="text-zinc-500">Close window</span></div>
          </CodeBlock>
        </CardContent></Card>
      ...
      <Card><CardHeader><CardTitle>Cache Manager (electron/cache-manager.ts)</CardTitle></CardHeader>
        <CardContent>
          <CodeBlock>
            ...
            <div>  <span className="text-emerald-500">get(key)</span>              <span className="text-zinc-500">Retrieve cached item (check TTL)</span></div>
            <div>  <span className="text-emerald-500">set(key, value, opts)</span> <span className="text-zinc-500">Store with TTL, content hash</span></div>
            <div>  <span className="text-emerald-500">invalidate(key)</span>       <span className="text-zinc-500">Remove specific entry</span></div>
            <div>  <span className="text-emerald-500">cleanup()</span>             <span className="text-zinc-500">Remove expired entries</span></div>
            <div>  <span className="text-emerald-500">stats()</span>               <span className="text-zinc-500">Hit count, size, expired count</span></div>
            <div>&nbsp;</div>
